...
def elitism_select(population):
    ...
    solution=[]
    pop=[]
    Z=[]      # listi az choromosom haye sort shode bar asas fitness
    X=[]      # listi moratab shode shamel tuple haie b shekle (fitness_value,choromosome)
    ...
    X.clear()
    Z.clear()
    d1=mutate(chorom_after_crossover[0])  #farzand #1 mutate shode
    d2=mutate(chorom_after_crossover[1])  #farzand #2 mutate shode
